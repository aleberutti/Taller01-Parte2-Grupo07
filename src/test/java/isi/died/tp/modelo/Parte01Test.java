...
public class Parte01Test {
    ...
    public static void main(String[] args){
        ...
        MaterialCapacitacion video1 = new Video("Tutorial Java 1", 199.0, 22.3);
        MaterialCapacitacion video2 = new Video("Tutorial Java 2", 152.0, 203.3);
        
        System.out.println("Video "+video1.getTitulo()+ " - Precio: "+video1.precio());
        System.out.println("Video "+video2.getTitulo()+ " - Precio: "+video2.precio());
        
        System.out.println("Liquidar Video 1!! ");
        video1.liquidar();
        System.out.println("Precio de Video 1 despues de liquidar: "+video1.precio());
